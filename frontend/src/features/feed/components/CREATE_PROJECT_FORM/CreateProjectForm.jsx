          ...
          {formData.collaborators.map((collaborator, index) => (
            <div key={collaborator.id} className={styles.collaboratorCard}>
              <div className={styles.collaboratorHeader}>
                <h4 className={styles.collaboratorTitle}>
              ...
              <div className={styles.collaboratorContent}>
                <div className={styles.formGroup}>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleDomainChange(collaborator.id, e.target.value)
                    }
                    disabled={isSubmitting}
                  >
                ...
                <div className={styles.formGroup}>
                  ...
                  <select
                    ...
                    value=""
                    onChange={(e) =>
                      handleSkillSelect(collaborator.id, e.target.value)
                    }
                    disabled={!collaborator.domain || isSubmitting}
                  >
                    <option value="">Select Skills</option>
                    {collaborator.domain &&
                      SKILLS_MAP[collaborator.domain]?.map((skill) => (
