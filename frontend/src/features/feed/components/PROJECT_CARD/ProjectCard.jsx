...
import { FaRegHeart, FaRegCommentAlt, FaShareAlt, FaClock, FaUsers } from 'react-icons/fa';
...
<FaUsers /> {project.collaborators.length} collaborator{project.collaborators.length > 1 ? 's' : ''}
</span>
)}
</div>
)}
...
<Button variant="ghost" onClick={handleLike} className={styles.actionButton}>
<FaRegHeart />
<span>{project.likes || 0}</span>
</Button>
<Button variant="ghost" onClick={handleComment} className={styles.actionButton}>
<FaRegCommentAlt />
<span>{project.comments || 0}</span>
</Button>
<Button variant="ghost" onClick={handleShare} className={styles.actionButton}>
<FaShareAlt />
</Button>
</div>
</Card>
